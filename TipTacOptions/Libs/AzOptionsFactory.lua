...
azof.objects.Slider = {
	...
	CreateNew = function(self)
		...
		f.edit = CreateFrame("EditBox",GenerateObjectName("EditBox"),f,BackdropTemplateMixin and "InputBoxTemplate");
		...
		f.slider = CreateFrame("Slider",sliderName,f,BackdropTemplateMixin and "OptionsSliderTemplate");

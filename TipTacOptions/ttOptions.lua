...
local options = {
	...
	{
		[0] = "Colors",
		{ type = "Check", var = "colorGuildByReaction", label = "Color Guild by Reaction", tip = "Guild color will have the same color as the reaction" },
...
f.btnAnchor = CreateFrame("Button",nil,f,BackdropTemplateMixin and "UIPanelButtonTemplate");
...
f.btnReset = CreateFrame("Button",nil,f,BackdropTemplateMixin and "UIPanelButtonTemplate");
...
f.btnClose = CreateFrame("Button",nil,f,BackdropTemplateMixin and "UIPanelButtonTemplate");

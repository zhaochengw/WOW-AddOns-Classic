...
function CreateConfigurationPanel()
    ...
    if Settings and Settings.RegisterCanvasLayoutCategory then
        local category = Settings.RegisterCanvasLayoutCategory(ConfigurationPanel, _)
        category.ID = "orbSellAndRepair"
        category.order = 1
    ...
    local ReputSliderLbl = ConfigurationPanel:CreateFontString(nil, "ARTWORK", "GameFontNormal")
    ...
    ConfigurationPanel.cancel = function(self)
        ...
        VendorWhitesBtn:SetChecked(orbSellAndRepair_settings.VendorGreys)
    end

    -- init
    ConfigurationPanel.cancel()

    configPanelRegistered = true
...
f:SetScript("OnEvent", function(self, event, arg1)
    if event == "ADDON_LOADED" and arg1 == "orbSellAndRepair" then
        LoadSettings()

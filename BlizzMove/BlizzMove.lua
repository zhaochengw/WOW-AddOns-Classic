...
movableFramesWithhandle = {
	["CharacterFrame"] =  { PaperDollFrame, ReputationFrame, SkillFrame, HonorFrame, PetPaperDollFrameCompanionFrame, PVPFrame, },
...
movableFramesLoD = {
	...
	["Blizzard_TalentUI"] = function() BlizzMove:SetMoveHandle(PlayerTalentFrame) BlizzMove:SetMoveHandle(TalentFrame) end,

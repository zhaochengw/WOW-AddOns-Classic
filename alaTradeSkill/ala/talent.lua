	...
	function __emulib.EncodeTalentData(classIndex, level, D1, D2, D3, N1, N2, N3)
		...
		if classIndex == 'player' then
			...
			elseif type(D1) == 'table' then
				...
				len = N1 + N2 + N3;
				for index = 1, N1 do data[len] = D1 and D1[index] or 0; end
				for index = 1, N2 do data[len] = D2 and D2[index] or 0; end
				for index = 1, N3 do data[len] = D3 and D3[index] or 0; end
			else

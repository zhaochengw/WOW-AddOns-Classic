...
local TextOnXPBar = MainMenuExpBar:CreateFontString("XPT_ExperienceLeft", "OVERLAY", "GameTooltipText")
TextOnXPBar:SetFont("Fonts\\ARIALN.TTF", 14, "THINOUTLINE")
TextOnXPBar:SetPoint("CENTER", "MainMenuExpBar", "CENTER", 0, 0)
...
--MainMenuBarOverlayFrame:HookScript("OnEnter", function(self)
...
--MainMenuBarOverlayFrame:HookScript("OnLeave", function(self)
	--GameTooltip:Show()
...
currentPetXP, nextPetXP = GetPlayerPetExperience()
currentplayerPetXP, nextlevelPetXP = GetPlayerPetExperience()
...
local petpercentage = math.ceil(((currentPetXP / nextPetXP)) * 100)

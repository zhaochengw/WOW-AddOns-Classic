	...
	items = {
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 24, 33582 }, -- 狂野侵略护足 熊
				{ 26, 33287 }, -- 纠结铁木肩甲 奶
				{ 27, 33557 }, -- 加尔贡的平静休眠护腕 奶
				{ 28, 33552 }, -- 疾速恢复短裤 奶
				{ 101, 34927 }, --黑暗时刻外套100
				{ 102, 34929 }, --寂静路途腰带75
				{ 103, 34928 }, --占星者侍从长裤100
				{ 105, 34906 }, --永恒勇武护胸100
				{ 106, 34911 }, --侵掠手套75
				{ 107, 34910 }, --桀骜长裤100
				{ 109, 34903 }, --星光之拥100
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 106, 34944 }, -- 沸腾怒气护腰75
				{ 107, 34943 }, -- 无尽怒火腿铠100
				{ 109, 34945 }, -- 沙塔斯护卫胸铠100
				{ 110, 34946 }, -- 奥尔多铭文腿铠100
				{ 111, 34947 }, -- 正义卫士胫甲75
				{ 113, 34921 }, -- 神职者的胸甲100
				{ 114, 34923 }, -- 弥补腰带75
				{ 115, 34922 }, -- 镇静腿甲100
				...
				{ 121, 32806 }, -- 老兵的鳞片腰带40
				{ 122, 32794 }, -- 老兵的鳞片护胫40
				{ 124, 32813 }, -- 老兵的板层甲护腕25
				{ 125, 32801 }, -- 老兵的板层甲腰带40
				{ 126, 32789 }, -- 老兵的板层甲护胫40
				{ 128, 32989 }, -- 老兵的雕饰板甲护腕25
				{ 129, 32988 }, -- 老兵的雕饰板甲腰带40
				{ 130, 32990 }, -- 老兵的雕饰板甲护胫40
			},
		},
		{
			name = ALIL["Weapon"],
			[NORMAL_DIFF] = {
				{ 1, 29275 }, -- Searing Sunblade
				{ 3, 33192 }, -- 雕刻过的巫医之杖
				{ 5, 34894 }, -- 锯刃
				{ 6, 34949 }, -- 无常
				{ 7, 34952 }, -- 毁伤
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 16, 29269 }, -- Sapphiron's Wing Bone
				{ 17, 29270 }, -- Flametongue Seal
				{ 18, 29271 }, -- Talisman of Kalecgos
				{ 19, 29272 }, -- Orb of the Soul-Eater
				{ 20, 29273 }, -- Khadgar's Knapsack
				{ 21, 29274 }, -- Tears of Heaven
				{ 23, 33334 }, -- 原始神灵雕像
				{ 24, 33325 }, -- 巫毒搅拌器
			},
		},
		...
		},
		{
			...
			[NORMAL_DIFF] = {
				...
				{ 3, 33504 }, -- 神圣意志圣契
				{ 4, 33502 }, -- 治愈圣契
				{ 6, 29389 }, -- Totem of the Pulsing Earth
				{ 7, 33509 }, -- 恐惧神像
				{ 8, 33508 }, -- 新生神像
				{ 9, 33510 }, -- 隐月神像
				{ 11, 29390 }, -- Everbloom Idol
				{ 12, 33506 }, -- 天鸣图腾
				{ 13, 33507 }, -- 碎石图腾
				{ 14, 33505 }, -- 活水图腾
			},

Skada:AddLoadableModule("Enemies", nil, function(Skada, L)
	...
	function done:OnEnable()
		...
		done.metadata 			= {click1 = doneplayers, icon = "Interface\\Addons\\Skada\\icons\\Inv_misc_monsterclaw_01"}
		taken.metadata 			= {click1 = takenplayers, icon = "Interface\\Addons\\Skada\\icons\\Inv_shield_08"}
	...
	function hdone:OnEnable()
		...
		hdone.metadata		= {click1 = hdonespells, icon = "Interface\\Addons\\Skada\\icons\\Inv_misc_bandage_12"}
		htaken.metadata		= {click1 = htakenspells, icon = "Interface\\Addons\\Skada\\icons\\Spell_misc_emotionhappy"}

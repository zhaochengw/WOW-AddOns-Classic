Skada:AddLoadableModule("Debuffs", nil, function(Skada, L)
	...
	function mod:OnEnable()
		mod.metadata 		= {showspots = 1, click1 = auramod, click2 = buffspells, icon = "Interface\\Addons\\Skada\\icons\\Ability_creature_disease_02"}
		auramod.metadata 	= {}
		buffs.metadata 		= {showspots = 1, click1 = buffspells, click2 = auramod, icon = "Interface\\Addons\\Skada\\icons\\Spell_misc_drink"}
		buffspells.metadata = {}
		buffoverview.metadata 		= {click1 = buffplayers, icon = "Interface\\Addons\\Skada\\icons\\Spell_misc_drink"}
		debuffoverview.metadata 	= {click1 = debuffplayers, icon = "Interface\\Addons\\Skada\\icons\\Ability_creature_disease_02"}

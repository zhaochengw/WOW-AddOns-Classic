...
if Settings then
    local category = Settings.RegisterCanvasLayoutCategory(CritSound_OptionsFrame, "CritSound")
	category.ID = CritSound_OptionsFrame.name
...
local function CritSoundMode_OnClick(self)
	...
	if CritSoundMode == 2 then
		CritSound_AgingTimeSlider:Enable()
		CritSound_AgingTimeSliderText:SetTextColor(1, 1, 1);
	else
		CritSound_AgingTimeSlider:Disable()
		CritSound_AgingTimeSliderText:SetTextColor(0.5, 0.5, 0.5);
	end
end
...
do
	...
	CreateFrame("Button", "CritSound_BlacklistShow", CritSound_OptionsFrame, "UIPanelButtonTemplate");
	CritSound_BlacklistShow:SetPoint("TOPLEFT", CritSound_BlacklistAdd, "TOPLEFT", 160, 0);
	CritSound_BlacklistShow:SetSize(110, 22)  -- 合并宽高设置
	CritSound_BlacklistShow.Text:SetText(CRITSOUND_SHOWALL);  -- 通过.Text属性设置
	...
	CreateFrame("Button", "CritSound_BlacklistClear", CritSound_OptionsFrame, "UIPanelButtonTemplate");
	CritSound_BlacklistClear:SetPoint("TOPLEFT", CritSound_BlacklistRem, "TOPLEFT", 160, 0);
	CritSound_BlacklistClear:SetSize(110, 22) -- 调整尺寸适配新模板
	CritSound_BlacklistClear.Text:SetText(CRITSOUND_CLEAR);

...
nodes[424] = { -- Pandaria
   [72275515] = { id = 313, name = L['Temple of the Jade Serpent'], type = "Dungeon" }, -- Temple of the Jade Serpent 
   [48117132] = { id = 302, name = L['Stormstout Brewery'], type = "Dungeon" }, -- Stormstout Brewery
   [40002920] = { id = 312, name = L['Shado-Pan Monastery'], type = "Dungeon" }, -- Shado-Pan Monastery
   [23575057] = { id = 324, name = L['Siege of Niuzao Temple'], type = "Dungeon" }, -- Siege of Niuzao Temple 
   [42975779] = { id = 303, name = L['Gate of the Setting Sun'], type = "Dungeon" }, -- Gate of the Setting Sun 
   [53745257] = { id = 321, name = L['Mogu\'shan Palace'], type = "Dungeon" }, -- Mogu'shan Palace (moved location cause of the LFR position)
   [49152606] = { id = 317, name = L['Mogu\'shan Vaults'], type = "Raid" }, -- Mogu'shan Vaults 
   [52355265] = { id = 369, name = L['Siege of Orgrimmar'], type = "Raid" }, -- Siege of Orgrimmar 
   [30076296] = { id = 330, name = L['Heart of Fear'], type = "Raid" }, -- Heart of Fear 
   [23100860] = { id = 362, name = L['Throne of Thunder'], type = "Raid" }, -- Throne of Thunder
   [56685529] = { id = 320, name = L['Terrace of Endless Spring'], type = "Raid" }, -- Terrace of Endless Spring  
}

--if self.db.profile.Zone then -- Can't remember what this is for

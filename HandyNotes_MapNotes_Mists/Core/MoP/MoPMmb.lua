...
OnTooltipShow = function(tooltip)
  ...
  tooltip:AddLine(ns.COLORED_ADDON_NAME .. " MoP")
  tooltip:AddLine(" ")
...
OnClick = function(self, button)
  ...
  if button == "LeftButton" then
    if not LibStub("AceConfigDialog-3.0"):Close("MNMiniMapButton_MistsSolo") then
      LibStub("AceConfigDialog-3.0"):Open("MNMiniMapButton_MistsSolo")
      LibStub("AceConfigDialog-3.0"):Close("HandyNotes")
    end
  end

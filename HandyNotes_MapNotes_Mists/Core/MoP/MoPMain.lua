...
local ADDON_NAME = "HandyNotes_MapNotes_Mists"
local L = LibStub("AceLocale-3.0"):GetLocale(ADDON_NAME)
ns.COLORED_ADDON_NAME = "|cffff0000Map|r|cff00ccffNotes|r"

local MapNotesMiniButton = LibStub("AceAddon-3.0"):NewAddon("MNMiniMapButton_MistsSolo", "AceConsole-3.0")
...
function MapNotesMiniButton:OnInitialize() --mmb.lua
  self.db = LibStub("AceDB-3.0"):New("MNMiniMapButton_MistsSoloDB", { profile = { minimap = { hide = false, }, }, }) 
  MNMMBIcon:Register("MNMiniMapButton_MistsSolo", ns.miniButton, self.db.profile.minimap)
end
...
do
    ...
    local GetBestMapForUnit = C_Map.GetBestMapForUnit("player")
      ...
      if (mapInfo.mapType == 2 and value.showOnContinent) then if not (ns.dbChar.ContinentDeletedIcons[t.uiMapId] and ns.dbChar.ContinentDeletedIcons[t.uiMapId][state]) then
...
local CapitalIDs = GetCurrentMapID == 84 or GetCurrentMapID == 87 or GetCurrentMapID == 89 or GetCurrentMapID == 103 or GetCurrentMapID == 85 or GetCurrentMapID == 90 
  ...
  StaticPopupDialogs["Delete_Icon?"] = {
    ...
    OnAccept = function()
      ...
      HandyNotes:SendMessage("HandyNotes_NotifyUpdate", "MapNotes_MistsSolo")
    end,
    OnCancel = function()
...
function Addon:PLAYER_LOGIN()
  ...
  self.db = LibStub("AceDB-3.0"):New("HandyNotes_MapNotes_MistsSoloDB", ns.defaults)
  ...
  -- Register options 
  HandyNotes:RegisterPluginDB("MapNotes_MistsSolo", ns.pluginHandler, ns.options)
  LibStub("AceConfigRegistry-3.0"):RegisterOptionsTable("MNMiniMapButton_MistsSolo", ns.options)
  ...
  if ns.Addon.db.profile.activate.HideMMB then -- minimap button
    MNMMBIcon:Hide("MNMiniMapButton_MistsSolo")
  end

...
if GetLocale() == "zhCN" then
    ...
    UFP_OP_Outline = "描边"
    UFP_OP_None = "无描边"
    UFP_OP_Outline_Thin = "细描边"
    UFP_OP_Outline_Thick = "粗描边"
elseif GetLocale() == "zhTW" then
    ...
    UFP_OP_Outline = "描邊"
    UFP_OP_None = "無描邊"
    UFP_OP_Outline_Thin = "細描邊"
    UFP_OP_Outline_Thick = "粗描邊"
else
    ...
    UFP_OP_Outline = "Outline"
    UFP_OP_None = "None"
    UFP_OP_Outline_Thin = "Thin"
    UFP_OP_Outline_Thick = "Thick"
end

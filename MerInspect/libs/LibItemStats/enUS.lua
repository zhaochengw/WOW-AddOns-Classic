...
if (locale == "enUS" or locale == "enGB") then
    ...
    LibItemStatsPatterns = {
        ...
        general = {
            ...
            { key = "SpellDamage",         pattern = "spell power" },
            ...
            { key = "SpellStrike",         pattern = "spell penetration" },
            { key = "SpellHitRating",      pattern = "hit rating" },
            { key = "SpellCrit",           pattern = "critical strike rating" },
            { key = "Healing", pattern = "spell power" },
            { key = "Healing", pattern = "治療法術" },
            { key = "Healing", pattern = "治療" },
            { key = "Dodge",   pattern = "dodge rating" },
            { key = "Parry",   pattern = "parry rating" },
            { key = "Defense", pattern = "defense rating" },
            { key = "HitRating", pattern = "hit rating" },
            { key = "RangedAttackPower", pattern = "ranged Attack Power" },		
            { key = "AttackCrit|RangedAttackCrit", pattern = "critical strike rating" },
        ...
        extra = {
            ...
            { key = "ManaRestore", pattern = "Restores %+(%d+) mana per 5 sec" },
            { key = "ManaRestore", pattern = "Restores %+(%d+) every 5 sec" },
            { key = "Resilience", pattern = "resilience rating by (%d+)" },
            { key = "SpellHitRating", pattern = "Improves hit rating by (%d+)" },
            { key = "HasteSpell", pattern = "Improves haste rating by (%d+)" },
            { key = "SpellCrit", pattern = "Improves critical strike rating by (%d+)" },
            { key = "SpellStrike", pattern = "Increases your spell penetration by (%d+)" },
            ...
            { key = "HasteMelee", pattern = "Improves haste rating by (%d+)" },
            { key = "RangedAttackPower", pattern = "Increases attack power by (%d+)" },
            { key = "AttackCrit|RangedAttackCrit", pattern = "Improves critical strike rating by (%d+)" },
            { key = "AttackPower|RangedAttackPower", pattern = "Increases attack power by (%d+)" },
            { key = "HitRating", pattern = "Improves hit rating by (%d+)" },
            { key = "Parry", pattern = "Increases your parry rating by (%d+)" },
            { key = "Defense", pattern = "Increases defense rating by (%d+)" },
            { key = "Dodge", pattern = "Increases your dodge rating by (%d+)" },
            { key = "Parry", pattern = "%+(%d+) Parry" },
            { key = "Defense", pattern = "%+(%d+) Defense" },
            { key = "Dodge", pattern = "%+(%d+) Dodge" },
            { key = "Block", pattern = "Increases the block value of your shield by (%d+)" },
            { key = "ReduceResistance", pattern = "Increases your spell penetration by (%d+)" },
            { key = "RangedAttackPower", pattern = "Increases attack power by (%d+)" },
            { key = "HitRating", pattern = "Improves hit rating by (%d+)" },
        },
        percent = {
        ...
        special = {
            ...
            { key = "ResistanceComa", value = 5, pattern = "Stun Resistance" },
            { key = "ManaRestore|HealthRestore", value = 4, pattern = "Health$" },
        ...
        buff = {
            ...
            { key = "Intellect", pattern = "Intellect by (%d+)"},
            { key = "ResistanceFrost", pattern = "冰霜抗性提高(%d+)"},
            { key = "Stamina|Agility|Strength|Intellect|Spirit", pattern = "all attributes by (%d+)"},
            { key = "Stamina|Agility|Strength|Intellect|Spirit", percent = true, pattern = "stats by (%d+)%%"},
            ...
            { key = "hp", pattern = "health increased by (%d+)"},
            ...
            { key = "SpellDamage", pattern = "Increases spell power by (%d+)"},
            { key = "SpellDamage", pattern = "Magical damage and healing from spells and effects increased by up to (%d+)"},
            { key = "RangedAttackPower", pattern = "遠程攻擊強度提高(%d+)"},
            { key = "AttackPower|RangedAttackPower", pattern = "Increases attack power by (%d+)"},
            { key = "AttackPower|RangedAttackPower", percent = true, pattern = "Attack Power increased by (%d+)%%"},
            ...
            { key = "Agility", pattern = "Increases your total Strength and Agility by (%d+)"},
            { key = "Strength", pattern = "Increases your total Strength and Agility by (%d+)"},
            { key = "Spirit", pattern = "and Spirit by (%d+)"},
            { key = "Intellect|Spirit", pattern = "Intellect by (%d+) and Spirit by (%d+)"},
            { key = "SpellDamage", pattern = "法術傷害和治療效果提高最多(%d+)"},
            { key = "SpellCrit", percent = true, pattern = "Increases spell critical chance by (%d+)%%"},

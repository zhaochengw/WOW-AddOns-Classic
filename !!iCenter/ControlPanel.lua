		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("tdBag2") then
					 ...
					 Settings.OpenToCategory("tdBag2");
					 Settings.OpenToCategory("tdBag2");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("BaudBag") then
					 ...
					 Settings.OpenToCategory("Baud Bag");
					 Settings.OpenToCategory("Baud Bag");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("Combuctor_Config") then
					 ...
					 Settings.OpenToCategory("Combuctor");
					 Settings.OpenToCategory("Combuctor");
				end;
				test = function()
...
-- 					end
-- 					 Settings.OpenToCategory("Inventorian");
-- 					 Settings.OpenToCategory("Inventorian");
-- 				end;
-- 				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("NugRunningOptions") then
					 ...
					 Settings.OpenToCategory("NugRunning");
					 Settings.OpenToCategory("NugRunning");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("ClassicCastbars") then
					 ...
					 Settings.OpenToCategory("ClassicCastbars");
					 Settings.OpenToCategory("ClassicCastbars");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("MovableCastBar") then
					 ...
					 Settings.OpenToCategory("MovableCastBar");
					 Settings.OpenToCategory("MovableCastBar");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("NeatPlates") then
					 ...
					 Settings.OpenToCategory("NeatPlates");
					 Settings.OpenToCategory("NeatPlates");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("OmniCC_Config") then
					 ...
					 Settings.OpenToCategory("OmniCC");
					 Settings.OpenToCategory("OmniCC");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					...
					collectgarbage("collect");
					UpdateAddOnMemoryUsage();
					 Settings.OpenToCategory("TinyTip");
					 Settings.OpenToCategory("TinyTip");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("TinyTooltip") then
					 ...
					 Settings.OpenToCategory("TinyTooltip");
					 Settings.OpenToCategory("TinyTooltip");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("MerInspect") then
					 ...
					 Settings.OpenToCategory("MerInspect");
					 Settings.OpenToCategory("MerInspect");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("ImprovedLootFrame") then
					 ...
					 Settings.OpenToCategory("ImprovedLootFrame");
					 Settings.OpenToCategory("ImprovedLootFrame");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("_NPCScan") then
					 ...
					 Settings.OpenToCategory("_|cffCCCC88NPCScan|r");
					 Settings.OpenToCategory("_|cffCCCC88NPCScan|r");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("Questie") then
					 ...
					 Settings.OpenToCategory("Questie");
					 Settings.OpenToCategory("Questie");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("ClassicCodex") then
					 ...
					 Settings.OpenToCategory("ClassicCodex");
					 Settings.OpenToCategory("ClassicCodex");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("felFruiTimer") then
					 ...
					 Settings.OpenToCategory("felFruiTimer");
					 Settings.OpenToCategory("felFruiTimer");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("bloodOfHeros") then
					 ...
					 Settings.OpenToCategory("bloodOfHeros");
					 Settings.OpenToCategory("bloodOfHeros");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					...
					if button == "LeftButton" then
						RecipeRadar_Toggle();
					elseif button == "RightButton" then
						 Settings.OpenToCategory("RecipeRadar");
						 Settings.OpenToCategory("RecipeRadar");
					end
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("PhanxChat") then
					 ...
					 Settings.OpenToCategory("PhanxChat");
					 Settings.OpenToCategory("PhanxChat");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("EasyFrames") then
					 ...
					 Settings.OpenToCategory("Easy Frames");
					 Settings.OpenToCategory("Easy Frames");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("LowHPPulser") then
					 ...
					 Settings.OpenToCategory("LowHPPulser");
					 Settings.OpenToCategory("LowHPPulser");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("BattleInfo") then
					 ...
					 Settings.OpenToCategory("BattleInfo");
					 Settings.OpenToCategory("BattleInfo");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("AdvancedInterfaceOptions") then
					 ...
					 Settings.OpenToCategory("AdvancedInterfaceOptions");
					 Settings.OpenToCategory("AdvancedInterfaceOptions");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					if not IsAddOnLoaded("orbSellAndRepair") then
					 ...
					 Settings.OpenToCategory("orbSellAndRepair");
					 Settings.OpenToCategory("orbSellAndRepair");
				end;
				test = function()
		...
		EarthFeature_AddButton(
			{
				...
				callback= function(button)
					Settings.OpenToCategory("iCenterMainCategory");
				end;
			}
		);
	end

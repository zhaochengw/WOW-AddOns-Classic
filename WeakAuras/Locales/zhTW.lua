...
L["Error decompressing. This doesn't look like a WeakAuras import."] = "解壓縮時出錯。這看起來不像是WeakAuras的匯入。"
...
L["Group Finder Mouse Over"] = "隊伍搜尋器滑鼠停留"
...
L["Warning: Anchoring to your own child '%s' in aura '%s' is imposssible."] = "警告：無法在光環 '%s' 中定位到您自己的子項 『%s』。"

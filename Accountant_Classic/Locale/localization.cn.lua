...
-- 货币追踪器 - 来源标签（Enum.CurrencySource）
-- 这些是用于货币追踪器来源代号的中文显示文本。
L["ConvertOldItem"] = "旧物品转换"
L["ConvertOldPvPCurrency"] = "旧PvP货币转换"
L["ItemRefund"] = "物品退款"
L["QuestReward"] = "任务奖励"
L["Cheat"] = "作弊"
L["Vendor"] = "商人"
L["PvPKillCredit"] = "PvP击杀积分"
L["PvPMetaCredit"] = "PvP元积分"
L["PvPScriptedAward"] = "PvP脚本奖励"
L["Loot"] = "掉落"
L["UpdatingVersion"] = "版本更新"
L["LFGReward"] = "LFG奖励"
L["Trade"] = "交易"
L["Spell"] = "法术"
L["ItemDeletion"] = "物品删除"
L["RatedBattleground"] = "评级战场"
L["RandomBattleground"] = "随机战场"
L["Arena"] = "竞技场"
L["ExceededMaxQty"] = "超出最大数量"
L["PvPCompletionBonus"] = "PvP完成奖励"
L["Script"] = "脚本"
L["GuildBankWithdrawal"] = "公会银行取款"
L["Pushloot"] = "推送拾取"
L["GarrisonBuilding"] = "要塞建筑"
L["PvPDrop"] = "PvP掉落"
L["GarrisonFollowerActivation"] = "要塞追随者激活"
L["GarrisonBuildingRefund"] = "要塞建筑退款"
L["GarrisonMissionReward"] = "要塞任务奖励"
L["GarrisonResourceOverTime"] = "要塞资源（随时间）"
L["QuestRewardIgnoreCapsDeprecated"] = "任务奖励（忽略上限，已弃用）"
L["GarrisonTalent"] = "要塞天赋"
L["GarrisonWorldQuestBonus"] = "要塞世界任务奖励"
L["PvPHonorReward"] = "PvP荣誉奖励"
L["BonusRoll"] = "额外拾取"
L["AzeriteRespec"] = "艾泽里特洗点"
L["WorldQuestReward"] = "世界任务奖励"
L["WorldQuestRewardIgnoreCapsDeprecated"] = "世界任务奖励（忽略上限，已弃用）"
L["FactionConversion"] = "阵营转换"
L["DailyQuestReward"] = "每日任务奖励"
L["DailyQuestWarModeReward"] = "每日任务战争模式奖励"
L["WeeklyQuestReward"] = "每周任务奖励"
L["WeeklyQuestWarModeReward"] = "每周任务战争模式奖励"
L["AccountCopy"] = "账号复制"
L["WeeklyRewardChest"] = "每周奖励宝箱"
L["GarrisonTalentTreeReset"] = "要塞天赋树重置"
L["DailyReset"] = "每日重置"
L["AddConduitToCollection"] = "将导灵器加入收藏"
L["Barbershop"] = "理发店"
L["ConvertItemsToCurrencyValue"] = "将物品转换为货币值"
L["PvPTeamContribution"] = "PvP团队贡献"
L["Transmogrify"] = "幻化"
L["AuctionDeposit"] = "拍卖行押金"
L["PlayerTrait"] = "玩家制作专业"
L["PhBuffer_53"] = "占位符 53"
L["PhBuffer_54"] = "占位符 54"
L["RenownRepGain"] = "名望声望获取"
L["CraftingOrder"] = "专业定制订单"
L["CatalystBalancing"] = "催化剂平衡"
L["CatalystCraft"] = "催化剂制造"
L["ProfessionInitialAward"] = "专业初始奖励"
L["PlayerTraitRefund"] = "玩家制作专业退款"
L["AccountHwmUpdate"] = "账号高水位更新"
L["ConvertItemsToCurrencyAndReputation"] = "将物品转换为货币和声望"

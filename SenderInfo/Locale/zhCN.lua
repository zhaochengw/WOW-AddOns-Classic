local L = LibStub("AceLocale-3.0"):NewLocale("SenderInfo", "zhCN");
if (not L) then
	return;
end
--[[
...
L["官方WCL显示"] = "  |cFFFF8000 官方WCL评分 |r  |cFFA335EE 数据来源:官方 |r";
L["非官方WCL显示"] = "  |cFFFF8000 非官方WCL评分 |r  |cFFA335EE 数据来源:非官方 |r";
...
L["使用官方WCL标题"] = "使用官方WCL";
L["使用官方WCL描述"] = "开启后使用官方WCL数据源，否则使用第三方WCL数据源";

L["使用非官方WCL标题"] = "使用非官方WCL";
L["使用非官方WCL描述"] = "开启后使用非官方WCL数据源，否则使用默认第三方WCL数据源";

L["WCL倒序显示标题"] = "倒序显示";
L["WCL倒序显示描述"] = "开启后WCL数据将按倒序显示";

L["WCL不显示击杀次数标题"] = "不显示击杀次数";
L["WCL不显示击杀次数描述"] = "开启后WCL数据中不显示击杀次数";

L["WCL10人普通标题"] = "10人普通";
L["WCL10人普通描述"] = "开启后显示10人普通难度的WCL数据";

L["WCL10人精英标题"] = "10人精英";
L["WCL10人精英描述"] = "开启后显示10人英雄难度的WCL数据";

L["WCL25人普通标题"] = "25人普通";
L["WCL25人普通描述"] = "开启后显示25人普通难度的WCL数据";

L["WCL25人精英标题"] = "25人精英";
L["WCL25人精英描述"] = "开启后显示25人英雄难度的WCL数据";
...
L["发送自己的WCL标题"] = "发送自己的WCL";
L["发送自己的WCL描述"] = "开启后发送自己信息时附带WCL评分";

L["发送使用官方WCL标题"] = "发送使用官方WCL";
L["发送使用官方WCL描述"] = "发送自己信息时使用官方WCL数据源";

L["发送使用非官方WCL标题"] = "发送使用非官方WCL";
L["发送使用非官方WCL描述"] = "发送自己信息时使用非官方WCL数据源";
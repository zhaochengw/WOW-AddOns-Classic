...
local function Open_ADD()
	...
	fuFrame.Open.biaoti:SetText("\124cffFFFF00自动开启目录\124r\124cff00FF00(拖拽物品到此)\124r");
	-- --滚动更新
	...
	fuFrame.Open:SetScript("OnEvent",function (self,event,arg1,arg2)
		if arg1 and arg2 then
			if CursorHasItem() then
				...
				fuFrame.Open.ADD:SetFrameLevel(48);
			end
		end
	end);
		...
		if CursorHasItem() then
			...
			for i=1,#shujuy do
				if fuFrame.Open.ADD.iteminfo[3]==shujuy[i][3] then
					...
					ClearCursor();
					fuFrame.Open.ADD.iteminfo={};
					fuFrame.Open.ADD:SetFrameLevel(40);
					return
				end			
			end
	...
	fuFrame.zidongKaiqi.Text:SetText("自动打开下方目录物品");

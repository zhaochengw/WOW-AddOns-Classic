...
for id = 1, hang_NUM do
	...
	jiangli_hang.shouru.E = CreateFrame('EditBox', nil, jiangli_hang.shouru, "BackdropTemplate");
	jiangli_hang.shouru.E:SetSize(60,hang_Height);
	jiangli_hang.shouru.E:SetBackdrop({ bgFile = "interface/common/common-input-border.blp",insets = {left = -6,right = 0,top = 2,bottom = -13}})

...
fuFrame.biaoti3_tishi:SetSize(30,30);
fuFrame.biaoti3_tishi:SetPoint("LEFT",fuFrame.biaoti3,"RIGHT",-6,0);
...
fuFrame.biaoti3_tishi_Texture:SetAllPoints(fuFrame.biaoti3_tishi)
...
for id = 1, hang_NUM do
	...
	fakuan_hang.shouru.E = CreateFrame('EditBox', nil, fakuan_hang.shouru, "BackdropTemplate");
	fakuan_hang.shouru.E:SetSize(60,hang_Height);
	fakuan_hang.shouru.E:SetBackdrop({ bgFile = "interface/common/common-input-border.blp",insets = {left = -6,right = 0,top = 2,bottom = -13}})
	...
	fakuan_hang.qiankuan.E = CreateFrame('EditBox', nil, fakuan_hang.qiankuan, "BackdropTemplate");
	fakuan_hang.qiankuan.E:SetSize(60,hang_Height);
	fakuan_hang.qiankuan.E:SetBackdrop({ bgFile = "interface/common/common-input-border.blp",insets = {left = -6,right = 0,top = 2,bottom = -13}})
...
fuFrame.Add.F.F.shiyou = CreateFrame('EditBox', nil, fuFrame.Add.F.F, "BackdropTemplate");
fuFrame.Add.F.F.shiyou:SetSize(200,34);
fuFrame.Add.F.F.shiyou:SetBackdrop({ bgFile = "interface/common/common-input-border.blp",insets = {left = -6,right = 0,top = 2,bottom = -13}})
...
fuFrame.Add.F.F.G = CreateFrame('EditBox', nil, fuFrame.Add.F.F, "BackdropTemplate");
fuFrame.Add.F.F.G:SetSize(80,34);
fuFrame.Add.F.F.G:SetBackdrop({ bgFile = "interface/common/common-input-border.blp",insets = {left = -6,right = 0,top = 2,bottom = -13}})

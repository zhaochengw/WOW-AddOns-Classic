...
--=====================================================================
--设置按钮
local Rsetting = CreateFrame("Button","Rsetting_UI",xiafangFrame_UI, "TruncatedButtonTemplate"); 
...
Rsetting:SetPoint("TOPLEFT",xiafangFrame_UI,"TOPLEFT",Width-70,-44);
...
Rsetting.Down:Hide();
--内容页-------------------------
local RsettingF = CreateFrame("Frame", "RsettingF_UI", Rsetting,"BackdropTemplate");
...
RsettingF:SetSize(Width-40,Height-104);
RsettingF:SetPoint("TOP",RaidR_UI,"TOP",0,-18);
RsettingF:SetFrameLevel(20);
RsettingF:EnableMouse(true);
tinsert(UISpecialFrames,"RsettingF_UI");
...
local function zhixingxiufucaizhi()
	...
	TabFrame_UI:SetBackdrop({bgFile = tihuanbgFile, 
	edgeFile = "interface/glues/common/textpanel-border.blp", 
	tile = false, tileSize = 0, edgeSize = 20,insets = { left = 4, right = 4, top = 4, bottom = 4 }});
...
RsettingF.zidonghuifuYY.F:SetBackdrop({edgeFile = "Interface/Tooltips/UI-Tooltip-Border", edgeSize = 16,insets = { left = 0, right = 0, top = 0, bottom = 0 }});
RsettingF.zidonghuifuYY.F:SetSize(310,28);
RsettingF.zidonghuifuYY.F:SetPoint("LEFT", RsettingF.zidonghuifuYY.biaoti, "RIGHT", 0,-0);
RsettingF.zidonghuifuYY.E = CreateFrame('EditBox', nil, RsettingF.zidonghuifuYY.F, InputBoxTemplate);
...
RsettingF.zidonghuifuYY.NR:SetBackdrop({edgeFile = "Interface/Tooltips/UI-Tooltip-Border", edgeSize = 16,insets = { left = 0, right = 0, top = 0, bottom = 0 }});
...
RsettingF.zidonghuifuYY.NR_E = CreateFrame('EditBox', nil, RsettingF.zidonghuifuYY.NR, InputBoxTemplate);
...
----加载设置---------------
addonTable.RaidRecord_RsettingF = function()

...
local function ADD_guanjianzi_open()
	...
	guanjianzi:SetScript("OnMouseDown",  function(self)
		self.Tex:SetPoint("CENTER", -9, -1.5);
	end)
	...
	---翻页按钮=======================
	local anniudaxiaoF = 32
	guanjianzi.F.ends = CreateFrame("Button",nil,guanjianzi.F, "TruncatedButtonTemplate");
	guanjianzi.F.ends:SetNormalTexture("interface/chatframe/ui-chaticon-scrollend-up.blp")
	guanjianzi.F.ends:SetHighlightTexture("interface/buttons/ui-common-mousehilight.blp");
	guanjianzi.F.ends:SetPushedTexture("interface/chatframe/ui-chaticon-scrollend-down.blp")
	guanjianzi.F.ends:SetSize(anniudaxiaoF,anniudaxiaoF);
	if PIG['ChatFrame']['fanyejianR']=="ON" then
		guanjianzi.F.ends:SetPoint("BOTTOMLEFT",guanjianzi.F,"BOTTOMRIGHT",0,6);
	else
		guanjianzi.F.ends:SetPoint("BOTTOMRIGHT",guanjianzi.F,"BOTTOMLEFT",-1,6);
	end
	guanjianzi.F.ends.hilight = guanjianzi.F.ends:CreateTexture(nil,"OVERLAY");
	guanjianzi.F.ends.hilight:SetTexture("interface/chatframe/ui-chaticon-blinkhilight.blp");
	guanjianzi.F.ends.hilight:SetSize(anniudaxiaoF,anniudaxiaoF);
	guanjianzi.F.ends.hilight:SetPoint("CENTER", 0, 0);
	guanjianzi.F.ends.hilight:Hide();
	...
	guanjianzi.F.down:SetPoint("BOTTOM",guanjianzi.F.ends,"TOP",0,0);
	...
	guanjianzi.F:SetScript("OnMouseWheel", function(self, delta)
		if delta == 1 then
			...
			guanjianzi.F.ends.hilight:Show();
		elseif delta == -1 then
	...
	guanjianzi.F.ends:SetScript("OnClick", function (self)
	...
	guanjianzi.F.shezhi:SetPoint("BOTTOM",guanjianzi.F.up,"TOP",-0,0);
	...
	guanjianzi.F.shezhi.F.fanyejian.Text:SetText("翻页键显示在右侧");
	guanjianzi.F.shezhi.F.fanyejian.tooltip = "翻页键显示在右侧";
	guanjianzi.F.shezhi.F.fanyejian:SetScript("OnClick", function (self)
		if self:GetChecked() then
			PIG['ChatFrame']['fanyejianR']="ON"
			guanjianzi.F.ends:ClearAllPoints();
			guanjianzi.F.ends:SetPoint("BOTTOMLEFT",guanjianzi.F,"BOTTOMRIGHT",0,4);
		else
			PIG['ChatFrame']['fanyejianR']="OFF"
			guanjianzi.F.ends:ClearAllPoints();
			guanjianzi.F.ends:SetPoint("BOTTOMRIGHT",guanjianzi.F,"BOTTOMLEFT",0,4);
		end
	end);
	if PIG['ChatFrame']['fanyejianR']=="ON" then
	...
	guanjianzi.F.guanjianzi:SetPoint("BOTTOM",guanjianzi.F.shezhi,"TOP",-0,0);
	...
	guanjianzi.F.guanjianzi.F.WList.Scroll:SetPoint("BOTTOMRIGHT",guanjianzi.F.guanjianzi.F.WList,"BOTTOMRIGHT",-20,0);
	...
	guanjianzi.F.guanjianzi.F.BList.Scroll:SetPoint("BOTTOMRIGHT",guanjianzi.F.guanjianzi.F.BList,"BOTTOMRIGHT",-21,0);
					...
					if jieshuweizhi then
						...
						if PIG['ChatFrame']['guolvchongfu']=="ON" then			
								...
								if PIG['ChatFrame']['guolvzishen']=="ON" then
									...
									local youjiahaozai=newTextxxx:find(zijiname, 1)
									if youjiahaozai then

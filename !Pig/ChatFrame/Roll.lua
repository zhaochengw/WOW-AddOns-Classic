...
local function ADD_Roll_Plus()
	...
	--父框架
	local RollF = CreateFrame("Frame", "RollF_UI", UIParent)
	RollF:SetSize(RollWidth, RollHeight)
	RollF:SetPoint("CENTER", UIParent, "CENTER", 0, 100)
	RollF:SetMovable(true)
	RollF:EnableMouse(true)
	RollF:SetClampedToScreen(true)
	RollF:Hide()
	tinsert(UISpecialFrames,"RollF_UI");
	--标题+拖拽按钮

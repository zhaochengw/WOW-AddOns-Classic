...
local function DuiyouFrame_Open()
	...
	for id = 1, MAX_PARTY_MEMBERS, 1 do
	    ...
	    --Party.Level:SetJustifyH("CENTER");
...
-------------------------
fuFrame.Duiyou = CreateFrame("CheckButton", nil, fuFrame, "ChatConfigCheckButtonTemplate");
fuFrame.Duiyou:SetSize(30,32);
fuFrame.Duiyou:SetHitRectInsets(0,-100,0,0);
fuFrame.Duiyou:SetPoint("TOPLEFT",fuFrame,"TOPLEFT",300,-20);
fuFrame.Duiyou.Text:SetText("队友头像增强");
fuFrame.Duiyou.tooltip = "增强队友头像，显示额外血量框架，常驻显示队友BUFF，显示队友目标等！\r|cff00FFFF小提示：|r\r队友职业图标可以点击，左击观察/右击交易。";
fuFrame.Duiyou:SetScript("OnClick", function (self)
	if self:GetChecked() then
		PIG['FramePlus']['TouxiangFrame_Duiyou']="ON";
		DuiyouFrame_Open();
	else
		PIG['FramePlus']['TouxiangFrame_Duiyou']="OFF";
		Pig_Options_RLtishi_UI:Show()
	end
end);
--=====================================
addonTable.UnitFrame_PartyMemberFrame = function()
	if PIG['FramePlus']['TouxiangFrame_Duiyou']=="ON" then

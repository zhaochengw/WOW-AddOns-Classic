...
DEX_FontList = {
	"Fonts\\ARKai_T.ttf",      -- 默认字体
	"Fonts\\ARHei.ttf",        -- 聊天字体
	"Fonts\\ARKai_C.ttf",      -- 战斗字体
	"Fonts\\ARIALN.TTF",       -- 数字字体
}
...
DEX_TXT_CRIT = "暴击! ";
DEX_TXT_INTERUPT = "打断! ";
DEX_MAIN_OPTION = "DamageEx-CWLK3.43-部落大人";
...
DEXOptionsFrameCheckButtons = {
	...
	["DEX_UniteSpell"] = { title = "合并多次同技能伤害", tooltipText = "如风怒武器、毁伤等瞬间对同一目标造成多次伤害的技能将被合并为一个伤害显示"},
	...
	["DEX_ShowAbsorb"] = { title = "显示吸收量", tooltipText = "在治疗数值后显示吸收量"},
}

...
function FOM_BuildFoodsUI(panel)
	...
	local borderFrame = CreateFrame("Frame", "FOM_FoodListBorder", panel, "BackdropTemplate")
	...
	borderFrame:SetSize(400, 273)  -- 合并宽高设置
	borderFrame:SetPoint("BOTTOMLEFT", panel, "BOTTOMLEFT", 12, 12)
	borderFrame:SetPoint("RIGHT", panel, -12, 0)

...
function ChatPlus_SlashHandler()
    ...
    -- New Settings API compatible open method
    if Settings and Settings.OpenToCategory then
        Settings.OpenToCategory("ChatPlus")
    else
        InterfaceOptionsFrame_OpenToCategory(ChatPlus_OptionsFrame)
        InterfaceOptionsFrame_OpenToCategory(ChatPlus_OptionsFrame) -- Legacy double call needed for panel focus
    end
end

...
spec:RegisterSetting( "metamorphosis_save", false, {
    name = strformat( "为燃烧阶段保留 %s”", Hekili:GetSpellLinkWithTexture( spec.abilities.metamorphosis.id ) ),
    desc = strformat( "如果勾选，仅会在燃烧阶段或黑暗灵魂激活时推荐使用%s。",
...
spec:RegisterSetting( "corruption_refresh", 30, {
    name = strformat( "%s刷新百分比", Hekili:GetSpellLinkWithTexture( spec.auras.corruption.id ) ),
    desc = strformat( "在%s持续时间剩余百分比低于此值时，建议刷新。",

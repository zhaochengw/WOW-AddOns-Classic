...
local defensiveSpells = {
	[642] = {name = '圣盾术',duration = 12, priority = 2} -- Divine Shield Rank 1
	, [1020] = {name = '圣盾术',duration = 12, priority = 2} -- Divine Shield Rank 2
	, [1022] = {name = '保护祝福',duration = 6, priority = 10} -- Blessing of Protection Rank 1
	, [5599] = {name = '保护祝福',duration = 6, priority = 10} -- Blessing of Protection Rank 2
	, [10278] = {name = '保护祝福',duration = 6, priority = 10} -- Blessing of Protection Rank 3
	, [498] = {name = '圣佑术',duration = 6, priority = 2} -- Divine Protection Rank 1
	, [5573] = {name = '圣佑术',duration = 6, priority = 2} -- Divine Protection Rank 2
	, [45438] = {name = '寒冰屏障',duration = 10, priority = 2} -- Ice Block
	, [19753] = {name = '神圣干涉',duration = 45, priority = 1} -- Divine Intervention 
								-- (Rarely held for full duration & frequently breaks from release->res)							
	
	, [26669] = {name = '闪避', duration = 15, priority = 20} -- Evasion Rank 2
	, [5277] = {name = '闪避', duration = 15, priority = 20} -- Evasion Rank 1
	, [871] = {name = '盾墙', duration = 10, priority = 5} -- Shield Wall
	, [45182] = {name = '装死', duration = 3, priority = 5} -- Cheat Death
	
	, [22812] = {name = '树皮术', duration = 12, priority = 30} -- Bark Skin
	, [30823] = {name = '萨满之怒', duration = 15, priority = 30} -- Shamanistic Rage
	, [33206] = {name = '痛苦压制', duration = 8, priority = 25} -- Pain Suppression
	
	, [20711] = {name = '救赎之魂', duration = 15, priority = 1} -- Spirit of Redemption
	, [29166] = {name = '激活', duration = 20, priority = 40} -- Innervate  
	} 
local shieldSpells = {
...
function HealBarsClassic:ChatCommand(args)
	...
	elseif arg == 'rc' then
		AceConsole:Print('|c42f581FFHealBarsClassic|r - 这些玩家在使用兼容插件时施放了治疗法术：\n')
		local nameSet = {}
		for frameName, unitFrame in pairs(masterFrameTable) do
		...
		AceConsole:Print('|c42f581FFHealBarsClassic|r\n'..
						'|c42f5daFF/hbc|r - 打开配置面板。\n'..
						'|c42f5daFF/hbc rc|r - 团队检查。只有在团队中其他安装兼容插件的队友施放治疗法术才会显示。')
	end
end

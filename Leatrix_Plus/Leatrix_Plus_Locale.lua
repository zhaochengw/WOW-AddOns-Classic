...
L["If checked, you will be able to pan (right-button) and zoom (mousewheel) in the character frame, dressup frame and inspect frame.  You will be able to middle-click the character model in the character frame to toggle character attributes.  Model rotation controls will be hidden.  Buttons to toggle gear will be added to the dressup frame."] = "Si está seleccionado, podrá desplazarse (botón derecho) y acercarse (rueda del ratón) en el marco del personaje, el marco del disfraz y el marco de inspección. Podrás hacer clic con el botón central en el modelo del personaje en el marco del personaje para alternar los atributos del personaje. Se ocultarán los controles de rotación del modelo. Los botones para alternar el equipo se agregarán al marco de disfraces."

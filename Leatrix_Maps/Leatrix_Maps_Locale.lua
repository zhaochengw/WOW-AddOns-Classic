...
L["Zul'Farrak"] = "祖尔法拉克"
L["Zul'Gurub"] = "祖尔格拉布"
L["Uldaman (side entrance)"] = "奥达曼(侧门)"
...
L["Dire Maul (East) (side entrance)"] = "厄运之槌（东）(侧面入口)"

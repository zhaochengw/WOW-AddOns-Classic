...
tt.close = CreateFrame("Button",nil,tt,BackdropTemplateMixin and "UIPanelCloseButton");
...
function tt:RemoveUnwantedLines(tip)
	for i = 2, tip:NumLines() do
		...
		if text~=nil then if (strsub(text,-1)==")") then line:SetText(nil); end; end; -- (strsub(text,1,6)=="Level ") or
	end
end

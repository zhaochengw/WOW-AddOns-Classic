...
function BG.ReceiveUI()
    ...
    do
        ...
        f:SetScript("OnEvent", function(self,even,...)
            ...
            if type == "历史表格" and historyname then
                local DT
                ...
                for b=1,Maxb[FB]+2 do
                    ...
                    for i=1,Maxi[FB] do
                        if BG.Frame[FB]["boss"..b]["zhuangbei"..i] then
                            ...
                            local c1,c2,c3 = BiaoGe.History[FB][DT]["boss"..b]["color"..i][1],BiaoGe.History[FB][DT]["boss"..b]["color"..i][2],BiaoGe.History[FB][DT]["boss"..b]["color"..i][3]
                            c1 = string.format("%.3f",c1)
                            c2 = string.format("%.3f",c2)
                            c3 = string.format("%.3f",c3)
                            BG.SendBiaoGe["boss"..b]["color"..i] = {c1,c2,c3}
            ...
            for index, value in ipairs(Receive) do
                ...
                if type == "END" then
                    ...
                    for b=1,Maxb[FB]+2 do
                        for i=1,Maxi[FB] do
                            if BG.ReceiveFrame[FB]["boss"..b]["zhuangbei"..i] then
                                BG.ReceiveFrame[FB]["boss"..b]["zhuangbei"..i]:SetText(BG.ReceiveBiaoGe["boss"..b]["zhuangbei"..i])
                                BG.ReceiveFrame[FB]["boss"..b]["maijia"..i]:SetText(BG.ReceiveBiaoGe["boss"..b]["maijia"..i])
                                ...
                                BG.ReceiveFrame[FB]["boss"..b]["jine"..i]:SetText(BG.ReceiveBiaoGe["boss"..b]["jine"..i])
                            end
                        end
                        if BG.ReceiveFrame[FB]["boss"..b]["time"] then
                            BG.ReceiveFrame[FB]["boss"..b]["time"]:SetText(BG.ReceiveBiaoGe["boss"..b]["time"])
                        end
                    end

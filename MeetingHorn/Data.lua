...
local ENCOUNTER_BOSSES = {
    ...
    [1109] = {
            ...
            children = {
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    T在面对BOSS的左边房间的三个台子边站位，开始先拉死亡骑士仇恨，在骑兵出来后拉住骑兵仇恨，死亡骑士由牧师锁住。\n2.    BOSS下楼后会在2个房间内传送， T注意拉住BOSS。',
                },
                {
                    role = 'HEALER',
                    expanded = false,
        ...
        abilities = {
            ...
            desc =
            '收割者戈提克自身难度不大，这场战斗主要是需要处理好BOSS下楼前的小怪。BOSS房间被分割为两部分，战斗开始中间门会关闭，变成2个独立的区域，在面对BOSS的左边房间被击杀的小怪会在右边房间复活。小怪被击杀完之后BOSS下楼，会并在两个房间内传送。',
        },
    },
    [1110] = {
        bossId = 1110,
        ...
        abilities = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    'BOSS攻击速度提高50%，对玩家造成的伤害提高。10人模式下膜拜者无法被精神控制，当膜拜者死亡之后，会造成一个范围冲击，解除BOSS的狂乱状态。25人模式下需要精神控制膜拜者，使用膜拜者的技能：黑女巫的拥抱使用后膜拜者会自爆，解除BOSS的狂乱状态。',
                },
            },
            desc =
            '黑女巫法琳娜身边有2个追随者和4个膜拜者，膜拜者是解除BOSS狂乱状态的关键，10人模式下击杀膜拜者即可解除BOSS狂乱效果，25人模式下需要控制膜拜者，使用黑女巫的拥抱技能，让膜拜者自爆解除。战斗期间BOSS还会释放群体毒箭和火雨。',
        },
    },
    [1111] = {
        bossId = 1111,
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    主T开怪后将BOSS拉至墙边，一旦BOSS脚下生成毒云就沿着墙后退，确保不会接触到毒云。\n2.    T需要将BOSS拉着背对或者是侧对着大团和近战，避免软泥喷射到人群。\n3.    副T拉住产生的小软泥怪。',
                },
            },
    ...
    [1112] = {
        ...
        abilities = {
            ...
            desc =
            '肮脏的希尔盖整体分为两个阶段，一阶段时BOSS可移动，10人模式下地面不会喷射熔岩，25人模式下地面会以固定规律喷射熔岩。二阶段BOSS在台子上释放技能无法靠近，台子下的地面会喷射熔岩，需要全团所有人一起跑动避开。二阶段结束后会回到一阶段，两阶段循环直至BOSS倒下。',
        },
        icon = '1378984',
        name = '肮脏的希尔盖',
    },
    [1113] = {
        ...
        summary = {
            children = {
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    由控制学员的人控制开怪，开启学员的白骨屏障和嘲讽技能将BOSS拉至靠近楼梯位置。学员白骨屏障快结束时，控制另外的学员使用白骨屏障和嘲讽技能顶上，轮流控制学员直至BOSS倒下。\n2.    主副T将其余学员拉至另一边，方便控制。',
                },
                {
                    role = 'HEALER',
                    expanded = false,
            ...
            desc =
            '教官拉苏维奥斯战斗开始后，10人模式下，需要操作场地上的控制水晶控制BOSS边上的死亡骑士学员（学员拥有白骨屏障和嘲讽技能），让学员开白骨屏障去坦BOSS。而25人模式下就需要牧师精神控制死亡骑士学员去坦克。',
        },
        icon = '1378988',
        name = '教官拉苏维奥斯',
    },
    [1114] = {
        ...
        summary = {
            ...
            desc =
            '克尔苏加德战斗开始时需要所有人站在场地中间输出小怪，进入P2阶段后，近战需要分堆站位，远程分散站位，确保不会在中冰霜冲击时连累太多人，战斗过程中躲避好脚下出现的暗影裂隙；进入P3后，副T拉住出现的小怪，其他人继续输出BOSS。',
        },
    },
    [1115] = {
        bossId = 1115,
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    开场后输出BOSS，孢子出现后，按照指挥分配，和队友一起去孢子刷新地点击杀孢子，吃到孢子的buff后返回全力输出BOSS。\n2.    吃孢子的时候和队友靠近，没有轮到的时候远离孢子，避免重复。',
                },
                {
                    role = 'RANGE',
                    expanded = false,
            ...
            desc =
            '洛欧塞布战斗开始后需要治疗们注意死灵光环的倒数计时，消失后有3秒时间将全团血量补满，然后光环会再次出现开始倒数，如此不断的循环，其余时间都需要帮助输出。近战和远程输出都需要轮流吃孢子，确保输出伤害和仇恨。',
        },
        zone = 2,
        name = '洛欧塞布',
        icon = '1378991',
        ...
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    进入战斗后对BOSS输出。BOSS瞬移时停止输出，等T拉住仇恨之后再输出。\n2.    BOSS上墙后帮助击杀小怪，第二次上墙后优先控制击杀天灾卫士。\n3.    BOSS下来后仍先击杀完小怪后再继续输出BOSS。',
                },
                {
                    role = 'TANK',
                    expanded = false,
                    desc =
                    '1.    主T开怪，将BOSS拉在房间正中间，BOSS瞬移后和从阳台上下来时，都需要主T及时拉住仇恨。副T站在人群外，等待拉住召唤出的小怪。\n2.    BOSS上平台后，召唤出的小怪需要T拉出人群后等待击杀。',
                },
                {
                    children = {
                    },
        ...
        abilities = {
            children = {
                ...
                },
                {
                    ...
                    title = '上平台',
                    desc =
                    '每隔一段时间BOSS会上到阳台上，无法被攻击，期间会在骨堆上召唤更多的精英小怪，每一次上墙召唤的小怪都比上一次更多，时间到达BOSS将会瞬移回房间正中位置。第一次召唤4个天灾勇士，第二次召唤4个天灾勇士+2个天灾卫士，第三次召唤与第二次相似。',
                },
            },
            desc =
            '药剂师诺斯战斗开始后会瞬移清空仇恨，期间还会释放群体残废，在战斗过程中会召唤精英小怪。每隔一段时间BOSS还会传送到墙上的阳台上召唤更多的精英小怪，期间无法被攻击。BOSS会在传送三次后进入狂暴状态，造成灭团伤害。',
        },
    },
    [1118] = {
        bossId = 1118,
    ...
    [1119] = {
        ...
        abilities = {
            ...
            desc =
            '萨菲隆战斗分为两个阶段，开始时为地面阶段，每隔60秒，BOSS进入空中阶段，会数次将随机一名玩家冻成冰块，且对冰块周围玩家造成大量的冰霜伤害。冰冻结束后，BOSS对场地正中间释放冰霜吐息，需要在冰块后躲避伤害，否则会被秒杀，吐息结束后BOSS回到地面阶段，两阶段循环直至BOSS倒下。',
        },
        zone = 5,
        name = '萨菲隆',
        icon = '1379010',
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    根据指挥分配站位，在BOSS两侧分散输出BOSS。法师第一时间驱散好诅咒。\n2.    躲好暴风雪。\n3.    BOSS上天后分散站位，冰霜吐息时第一时间到冰块后躲避。',
                },
                {
                    role = 'TANK',
                    expanded = false,
    ...
    [1120] = {
        ...
        abilities = {
                    ...
                    children = {
                        {
                            ...
                            expanded = false,
                            desc =
                            '每隔一段时间会对所有玩家随机释放正能量电荷或者负能量电荷，相同电荷玩家互相靠近时，会周围给同电荷玩家提高造成的伤害BUFF。不同电荷玩家相互靠近时，会对附近所有玩家造成伤害。',
                        },
                        {
                            spell = '28167',
                            title = '闪电链',
            ...
            desc =
            '塔迪乌斯战斗分为2个阶段，第一阶段需要先同时击杀两边小平台的小boss斯塔拉格和费尔根，第二阶段需要跳至BOSS所在平台等待BOSS激活，BOSS每隔一段时间会释放电荷，所有人需要查看身上的电荷正负极，根据指挥分配位置和其他同一种电荷的站在一起。6分钟内没有击杀则BOSS狂暴。',
        },
        icon = '1379019',
        summary = {
            children = {
                ...
                },
                {
                    ...
                    children = {
                        ...
                        },
                        {
                            ...
                            title = '塔迪乌斯阶段',
                            desc =
                            '1.    跳上BOSS所在平台后，主T站在BOSS前方等待BOSS激活后拉住仇恨。\n2.    BOSS释放电荷时第一时间查看身上电荷标记，然后按照指挥分配和其他同一种电荷（加号或者减号）的人一起站在BOSS侧面。每一次电荷变换均要注意，电荷仍旧为正极或者负极就原地不动，若正极变为负极，或者负极变为正极，就跑至BOSS对面，确保和所有同样电荷玩家站在一起。循环直至BOSS倒下。',
                        },
                    },
                },
            },
            desc =
            '塔迪乌斯战斗开始后需要先击杀两个平台上的小BOSS，小BOSS需要同时击杀，否则会再次复活，击杀之后跳至BOSS所在平台开启BOSS战。战斗期间BOSS释放电荷时注意自身的电荷属性，同一种电荷的站在一起会增加攻击力，而不同电荷的站一起会受到伤害。',
        },
    },
    [1121] = {
        bossId = 1121,
        abilities = {
            ...
            desc =
            '天启四骑士有4个BOSS，分别是瑞文戴尔男爵、库尔塔兹领主、瑟里耶克爵士、女公爵布劳缪克丝，4个BOSS都有各自的光环印记和独特技能，相同光环印记可叠加，层数越高受到的伤害越多，每个BOSS的印记互不干涉。开战后BOSS会自动跑向房间的四个角落。',
        },
        zone = 3,
        name = '天启四骑士',
        icon = '1385732',
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    10人模式下需要主T拉住库尔塔兹领主和瑞文戴尔男爵。副T和一个血量较高的治疗去内场分别站在女公爵布劳缪克丝和瑟里耶克爵士附近。光环叠加过高时两个人互换位置即可。击杀完前场的两个BOSS，再去拉住后场两个BOSS。\n2.    25人模式下需要主T前往靠近大门的左侧角落拉住库尔塔兹领主。副T前往靠近大门的右侧角落拉住瑞文戴尔男爵。\n主T在库尔塔兹领主死后接手瑞文戴尔男爵，此时副T需要前往台子上等待消除印记，待印记消除后再去接手瑞文戴尔男爵。\n女公爵布劳缪克丝和瑟里耶克爵士需要2个血量较高的人去抗住伤害。在印记叠加过3层后交换位置即可。',
                },
            },
            desc =
            '天启四骑士开场后需要大团优先击杀库尔塔兹领主，然后再去输出瑞文戴尔男爵，两个BOSS杀完之后再击杀剩余两个，注意一种印记叠加过高之后就需要切换到另一个BOSS处输出。瑟里耶克爵士和女公爵布劳缪克丝前期只需要他们的光环范围内有人，在光环叠加过高之后换位置去另一个BOSS范围内，待光环消除之后再更换回来即可。',
        },
    },
    [1094] = {
        bossId = 1094,
        abilities = {
            ...
            desc =
            '整个永恒之眼副本只有玛里苟斯一个BOSS，整场战斗分为3个阶段。第一阶段在场地正中间，BOSS血量降低至50%的血量会进入第二阶段，玛里苟斯进入无法攻击状态，场地内出现站在飞盘上的小怪，在击杀完所有小怪后进入第三阶段，场地会被摧毁，全员骑龙，且使用龙的技能作战。',
        },
        name = '玛里苟斯',
        icon = '1385753',
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    'P1：在BOSS侧面输出BOSS，优先击杀能量火花。火花死亡后地面会留下一个光环，站在上面可以增加伤害。在漩涡结束后立即离开BOSS龙头方向。\nP2：优先击杀地面上的小怪，然后再输出远程小怪，在蓝龙盾内躲避BOSS的深呼吸和远程小怪的技能，盾范围缩小后及时更换位置。\nP3：失去自身职业技能，全部使用坐骑龙的技能，按照指挥安排进行治疗或者输出。负责输出的可以按两下1技能，然后就按2技能叠加伤害，血少的按4技能回血。负责治疗的可以按两下3技能，再按4技能，所有人中点名技能了按5减伤。躲好BOSS放出的秘法球。',
                },
                {
                    role = 'TANK',
                    expanded = false,
                    desc =
                    'P1：主T将BOSS拉在中间，漩涡下地后立即拉住BOSS，避免龙头面向大团。\nP2：拉住降至地面的近战小怪，在蓝龙盾内躲避BOSS的深呼吸和远程小怪的技能。盾范围缩小后及时更换位置。\nP3：失去自身职业技能，全部使用坐骑龙的技能，按照指挥安排进行治疗或者输出。负责输出的可以按两下1技能，然后就按2技能叠加伤害，血少的按4技能回血。负责治疗的可以按两下3技能，再按4技能，所有人中点名技能了按5减伤。躲好BOSS放出的秘法球。',
                },
            },
            desc =
            '玛里苟斯战斗分为三阶段，一阶段在场地正中间开打，BOSS会飞到空中释放漩涡，还会召唤火花，一旦火花被BOSS吸收掉就会提升BOSS攻击力。BOSS血量降低至50%的血量会进入第二阶段，场面上出现站在飞盘上的小怪，清理完之后进入第三阶段，场地会被摧毁，全员骑龙，失去自身的职业技能，使用龙的技能作战。',
        },
    },
    [1126] = {
        bossId = 1126,
        summary = {
            children = {
                ...
                },
                {
                    ...
                    expanded = false,
                    desc =
                    '1.    分散站位治疗全团，特别是注意中岩石碎片和重压跳跃技能的人。主T在被穿刺时也需要照顾好两个坦克的血量。\n2.    若边上有人中了岩石碎片技能，赶紧远离中技能的人。\n3.    远离重压跳跃后产生的云雾。',
                },
                {
                    role = 'RANGE',
                    expanded = false,
    ...
    [742] = {
        ...
        abilities = {
            desc =
            '黑曜石圣殿只有萨塔里奥一个BOSS，在面对他之前要先清理周围的小怪，还有他的三条暮光幼龙“维斯匹隆”、“塔尼布隆”和“沙德隆”。BOSS萨塔里奥战斗开始后会从两边的熔岩内不断召唤熔岩元素，每隔一段时间还会召唤熔岩墙扫过战斗区域，随机释放的火雨也是需要注意的。',
        },
        name = '萨塔里奥',
        summary = {
            desc =
            '黑曜石圣殿内的三个暮光幼龙可以选择性击杀，每保留一个幼龙副本难度会增加且BOSS多一件装备掉落。在BOSS战时BOSS会召唤未被击杀的暮光龙，且每条龙在场地上被击杀时都会导致BOSS攻击增加。BOSS战时需要大团在场地侧面输出，躲避出现的所有技能。',
        },
        icon = '1385765',
    },
    [734] = {
